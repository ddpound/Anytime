...
function searchPlaces() {
	...
	var keyword = document.getElementById('schoolName').value;
...
function searchSchool() {
	...
	console.log("js 에서만 직접 가져온 값 : " + form.schoolName)
	$.ajax({
		url: getContextPath() + '/searchSchoolMap', type: 'POST', dataType: 'json',
		...
		success: function(SchoolResult) {
			...
			for (idx = 0; idx < temp.dataSearch.content.length; idx++) {
				console.log(temp.dataSearch.content[idx].schoolName)
