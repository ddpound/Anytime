...
public  final class KakaoLoginInfo {
	...
	public static final String LoginRequestURI = "https://kauth.kakao.com/oauth/authorize?"
			...
			+ "redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code HTTP/1.1";
	...
	public static final String redirect_uri = "http://localhost:8000/root/auth/kakao/callback"; // 여기도 맞게 변경바람
	public static final String Loginredirect_uri ="http://localhost:8000/root/auth/kakao/login/callback";// 여기도 맞게 변경바람
